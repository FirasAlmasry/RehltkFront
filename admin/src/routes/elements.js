...
export const UserOrderListPage = Loadable(
    lazy(() => import("../pages/dashboard/UserOrderListPage"))
);
// DASHBOARD: Employment

export const EmploymentListPage = Loadable(
    lazy(() => import("../pages/dashboard/employment/EmploymentListPage"))
);
export const EmploymentCreatePage = Loadable(
    lazy(() => import("../pages/dashboard/employment/EmploymentCreatePage"))
);
export const EmploymentOrderListPage = Loadable(
    lazy(() => import("../pages/dashboard/employment/EmploymentOrderListPage"))
);
export const EmploymentEditPage = Loadable(
    lazy(() => import("../pages/dashboard/employment/EmploymentEditPage"))
);

// DASHBOARD: Company

export const CompanyListPage = Loadable(
    lazy(() => import("../pages/dashboard/company/CompanyListPage"))
);
export const CompanyCreatePage = Loadable(
    lazy(() => import("../pages/dashboard/company/CompanyCreatePage"))
);
export const CompanyOrderListPage = Loadable(
    lazy(() => import("../pages/dashboard/company/CompanyOrderListPage"))
);
export const CompanyEditPage = Loadable(
    lazy(() => import("../pages/dashboard/company/CompanyEditPage"))
);
...
export const ComplaintListPage = Loadable(
    lazy(() => import("../pages/dashboard/complaint/ComplaintListPage"))
);
...
export const TourListPage = Loadable(
    lazy(() => import("../pages/dashboard/tour/TourListPage"))
);
...
// DASHBOARD: CONSOLTING
// export const ConsoltingProfilePage = Loadable(
...
export const FoundationTypographyPage = Loadable(
    lazy(() =>
        import("../pages/components/foundation/FoundationTypographyPage")
    )
);
