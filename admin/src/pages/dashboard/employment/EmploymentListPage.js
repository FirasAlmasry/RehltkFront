...
import {
    ...
    EmploymentTableRow,
} from "../../../sections/@dashboard/employment/list";
import { useDeleteEmploymentMutation, useGetEmploymentQuery } from "../../../state/ApiEmployment";
// ----------------------------------------------------------------------
...
export default function EmploymentListPage() {
    ...
    const handleEditRow = (id) => {
        navigate(PATH_DASHBOARD.employment.edit(paramCase(id)));
    };
    ...
    return (
        <>
            <Helmet>
                <title> Employment: List | Rehltk</title>
            </Helmet>

            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    heading="Employment List"
                    links={[
                        { name: "Dashboard", href: PATH_DASHBOARD.root },
                        {
                            name: "employment",
                            href: PATH_DASHBOARD.employment.root,
                        },
                        { name: "List" },
                    ]}
                    action={
                        <Button
                            ...
                            to={PATH_DASHBOARD.employment.new}
                            variant="contained"
