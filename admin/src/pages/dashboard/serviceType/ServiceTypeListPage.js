...
// sections
import {
    ServiceTypeTableToolbar,
    ServiceTypeTableRow,
} from "../../../sections/@dashboard/serviceType/list";
...
const TABLE_HEAD = [
    { id: "title ar", label: "Title ar", align: "left" },
    { id: "title en", label: "Title en", align: "left" },
    { id: "" },
];
...
export default function ServiceTypeListPage() {
    ...
    return (
        <>
            <Helmet>
                <title> ServiceType: List | Rehltk</title>
            </Helmet>
            ...
            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        {
                            name: "ServiceType",
                            href: PATH_DASHBOARD.serviceType.root,
                        },
                        { name: "List" },
                    ]}
                    action={
