...
import { useDeleteCountryMutation, useGetCountryQuery } from "../../../state/ApiCountry";
...
export default function CountryListPage() {
    ...
    useEffect(() => {
        if (data) {
            setTableData(data.data.countrys)
        }
    }, [data])
    ...
    return (
        <>
            <Helmet>
                <title> Country: List | Rehltk</title>
            </Helmet>
