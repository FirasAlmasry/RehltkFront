...
// sections
import {
    ConsoltingTableToolbar,
    ConsoltingTableRow,
} from "../../../sections/@dashboard/consulting/list";
...
const TABLE_HEAD = [
    ...
    { id: "active", label: "IsActive", align: "center" },
    { id: "" },
];
...
export default function UserListPage() {
    ...
    const [tableData, setTableData] = useState(_consoltingList);
