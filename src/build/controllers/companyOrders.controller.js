...
exports.updateCompanyOrders = exports.searchCompanyOrders = exports.getCompanyOrdersById = exports.getAllCompanyOrderss = exports.deleteCompanyOrders = exports.createCompanyOrders = void 0;
var _regenerator = _interopRequireDefault(require("@babel/runtime/regenerator"));
var _asyncToGenerator2 = _interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));
var _httpStatusCodes = _interopRequireDefault(require("http-status-codes"));
var CompanyOrdersService = _interopRequireWildcard(require("../services/companyOrders.service"));
...
var getAllCompanyOrderss = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return CompanyOrdersService.getAllCompanyOrderss(req);
        case 3:
          data = _context.sent;
  ...
  return function getAllCompanyOrderss(_x, _x2, _x3) {
...
var getCompanyOrdersById = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return CompanyOrdersService.getCompanyOrdersById(req.params.id);
        case 3:
          data = _context2.sent;
          res.status(_httpStatusCodes["default"].OK).json({
            code: _httpStatusCodes["default"].OK,
  ...
  return function getCompanyOrdersById(_x4, _x5, _x6) {
...
var createCompanyOrders = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return CompanyOrdersService.isCreateCompanyOrdersDataValide(req.body);
        case 3:
          _context3.next = 5;
          return CompanyOrdersService.createCompanyOrders(req.body);
        case 5:
          data = _context3.sent;
          _context3.next = 8;
  ...
  return function createCompanyOrders(_x7, _x8, _x9) {
...
var updateCompanyOrders = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res, next) {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _context4.next = 5;
          return CompanyOrdersService.updateCompanyOrders(req.params.id, req.body);
        case 5:
          data = _context4.sent;
  ...
  return function updateCompanyOrders(_x10, _x11, _x12) {
...
var deleteCompanyOrders = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res, next) {
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          _context5.next = 5;
          return CompanyOrdersService.deleteCompanyOrders(req.params.id);
        case 5:
          res.status(_httpStatusCodes["default"].OK).json({
            code: _httpStatusCodes["default"].OK,
            data: [],
  ...
  return function deleteCompanyOrders(_x13, _x14, _x15) {
...
var searchCompanyOrders = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return CompanyOrdersService.searchCompanyOrderss(req);
        case 3:
          data = _context6.sent;
          res.status(_httpStatusCodes["default"].OK).json({
            code: _httpStatusCodes["default"].OK,
  ...
  return function searchCompanyOrders(_x16, _x17, _x18) {
    return _ref6.apply(this, arguments);
  };
}();
exports.searchCompanyOrders = searchCompanyOrders;